...
public static class LeapSeconds
{
    ...
    /// <summary>
    /// Returns the cumulative TAI − UTC (in seconds) for a given UTC instant, using the latest table entry not after the instant.
    /// </summary>
    public static int SecondsBetweenUtcAndTai(System.DateTime utc)
    {
