...
/// </summary>
public sealed class UnsupportedTimeInstantException : Exception
{
    ...
    public DateTime LastSupportedUtc { get; }
    ...
    public UnsupportedTimeInstantException(DateTime utc, DateTime lastSupportedUtc, string? message = null)
